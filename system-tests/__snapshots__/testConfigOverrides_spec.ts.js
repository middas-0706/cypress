...
exports['testConfigOverrides / fails when trying to perform testConfigOverrides for Cypress.env() with disallowCypressEnv=true'] = `
...
====================================================================================================
  ...
  │ Cypress:    1.2.3                                                                              │
  │ Browser:    FooBrowser 88                                                                      │
  │ Specs:      1 found (disallow_cypress_env.cy.js)                                               │
  │ Searched:   cypress/e2e/testConfigOverrides/disallow_cypress_env.cy.js                         │
  └────────────────────────────────────────────────────────────────────────────────────────────────┘


────────────────────────────────────────────────────────────────────────────────────────────────────
                                                                                                    
  Running:  disallow_cypress_env.cy.js                                                      (1 of 1)


  testConfigOverrides with disallowCypressEnv=true
  ...
  1) testConfigOverrides with disallowCypressEnv=true
       fails when trying to perform testConfigOverrides for Cypress.env():
     CypressError: overriding environment variables via suite or test configuration is not allowed when \`disallowCypressEnv\` is set to \`true\`.

https://docs.cypress.io/app/references/environment-variables#Option-5-Test-Configuration
      [stack trace lines]
  ...
  │ Video:        false                                                                            │
  │ Duration:     X seconds                                                                        │
  │ Spec Ran:     disallow_cypress_env.cy.js                                                       │
  └────────────────────────────────────────────────────────────────────────────────────────────────┘
...
====================================================================================================
  ...
  (Run Finished)
       ...
       Spec                                              Tests  Passing  Failing  Pending  Skipped  
  ┌────────────────────────────────────────────────────────────────────────────────────────────────┐
  │ ✖  disallow_cypress_env.cy.js               XX:XX        1        -        1        -        - │
  └────────────────────────────────────────────────────────────────────────────────────────────────┘
    ✖  1 of 1 failed (100%)                     XX:XX        1        -        1        -        -  
